...
file_search_test_cases = [
    ...
    FileSearchTestCase(
        description="Multiple filenames including multiple special characters do match correctly",
        file_names=["Song-1.mp3", "Song 1_.mp3"],
        durations=[10.0, 10.0],
        search_term="Song 1??",
        expected=[("Song 1_.mp3", 10.0)],
    ...
    FileSearchTestCase(
        ...
        durations=[10.0],
        search_term="this is a really long title that far exceeds the character limit",
        expected=[("this is a really long title that far exceeds th.mp3", 10.0)],
    ),
]
